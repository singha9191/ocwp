						...
						<?php
							if( !get_theme_mod( 'disable_pagination', false ) ):
								the_posts_pagination( array(
									'next_text' => '<span>'.esc_html__( 'Next', 'bosa-fitness' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-fitness' ) . '</span>',
									'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-fitness' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-fitness' ) . '</span>',
									'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-fitness' ) . ' </span>',
								));
							endif;
						?>
					</div><!-- #primary -->
